...
@export var colorInactive: Color
...
func _unhandled_input(event):
	...
	if _captureButton.button_pressed and event.is_action_pressed("ui_up"):
		_rectUp.color = colorActive
	elif event.is_action_released("ui_up") and _rectUp.color == colorActive:
		_rectUp.color = colorInactive
	elif _captureButton.button_pressed and event.is_action_pressed("ui_down"):
	...
	elif _captureButton.button_pressed and event.is_action_pressed("ui_left"):
	...
	elif _captureButton.button_pressed and event.is_action_pressed("ui_right"):
